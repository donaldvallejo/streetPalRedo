...
def services_index():
  ...
  return render_template('streetPals_index.html', services=services)

@app.route('/streetPals/new')
def services_new():
  """Create services"""
  return render_template('streetPals_new.html', services = {}, title='New services')
...
def services_show(service_id):
    ...
    print(service)
    return render_template('streetPals_show.html', service=service, comments=service_comments)
...
def services_edit(service_id):
    ...
    #services.update_one({"_id":service_id}, {"$set": service_update})
    services.update_one({"_id":service_id, **service_update})
    return render_template('streetPals_edit.html', service=service, title='Edit service')
...
def comments_new():
    ...
    return redirect(url_for('services_show', comment_id=comment_id, service_id=request.form.get('service_id')))
...
def comments_delete(comment_id):
    ...
    return redirect(url_for('services_show', comment_id=comment._id, service_id=comment.get('service_id')))
